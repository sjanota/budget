      ...
      X =
        a.found && n.found
          ? ((w = (b = q).children),
            ...
            (z = { tag: 'rect', attributes: G({}, zt, { fill: 'white' }) }),
            ...
            (j = {
              ...
              children: [
                Et(
                  G({ tag: S.tag, attributes: G({}, S.attributes, M.path) }, E)
                ),
              ],
            }),
            (L = { tag: 'g', attributes: G({}, M.outer), children: [j] }),
            (R = 'mask-'.concat(kt())),
            (_ = 'clip-'.concat(kt())),
            (T = {
              tag: 'mask',
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix &&
          1 === i.length &&
          (o.iconName = Vt(o.prefix, Dt(t.innerText))),
      o
    );
  }
  var le = function(t) {
  ...
  var de = { fill: 'currentColor' },
    ...
    ge = {
      ...
      children: [
        ...
        {
          tag: 'circle',
          attributes: G({}, de, { cx: '256', cy: '364', r: '28' }),
          children: [
            {
              tag: 'animate',
              attributes: G({}, me, {
            ...
            {
              tag: 'animate',
              attributes: G({}, he, { values: '1;0;1;1;0;1;' }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: G({}, he, { values: '1;0;0;0;0;1;' }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: G({}, he, { values: '0;0;1;1;0;0;' }),
            },
          ],
        },
      ],
      ...
      ((Le = function(t) {
        ...
        if (t) {
          var g = t.prefix,
            v = t.iconName,
            b = t.icon;
          return Ee(G({ type: 'icon' }, t), function() {
            return (
              ze(),
              J.autoA11y &&
                (l
