...
func TestStorage_CreateCategory(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		input := &models.CategoryInput{Name: *mock_models.Name(), EnvelopeID: envelope.ID}
	...
	t.Run("EnvelopDoesNotExist", func(t *testing.T) {
		input := &models.CategoryInput{Name: *mock_models.Name(), EnvelopeID: primitive.NewObjectID()}
